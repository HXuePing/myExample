...
<div style="margin-left: 190px;margin-top: 50px;">
	<table id="dg" title="违规信息管理" class="easyui-datagrid" style="width:700px;height:365px"
            url="/myExample/manager/showallsuggestionlist"
            toolbar="#toolbar" pagination="true"
            rownumbers="true" fitColumns="true" singleSelect="true">
        <thead>
            <tr>
            	<th field="suggestionNumber" width="50" >学号</th>
                <th field="suggestionName" width="50">姓名</th>
                <th field="suggestionDecription" width="50">详细描述</th>
                <th field="suggestionType" width="50">违规类型</th>              
            </tr>
        </thead>
    </table>
    <div id="toolbar">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-export" plain="true" onclick="exportUser()">导出</a>
